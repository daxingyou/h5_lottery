...
$(function () {
    $('#m_dd_more').live('click', function () {
        ...
        $('#my_dd_iframe').load(function () {
            $('#my_dd_iframe').contents()
                .find('header, .height_top_3rem')
                .css('display', 'none');
            if (_this.parent('.msgCheck')) {
                _this.siblings('em').addClass('Check')
                    .text('已查看');
            }
        });
    });
...
$(function () {
    ...
    h3.each(function (i) {
        $(this).click(function () {
            ...
            $(this).children('i')
                .toggleClass('lnstruction-up');
            tree_one.eq(i).parent()
                .siblings()
                .find('.tree_one')
                .slideUp(100);
        });
...
$(function () {
    ...
    $('#copy_btn').live('click', function () {
        var list_url = $(this).siblings('.link-txt')
            .find('em')
            .html();
        layer.open({
...
$(function () {
    ...
    if (isPnChecked == 'true') {
        $('.prize-notification span').removeClass()
            .addClass('uncheck');
    } else {
        $('.prize-notification span').removeClass()
            .addClass('check');
