...
function initPopFengpan() {
    $(".so-fengpan-pop-click").click(function () {
        $(".so-fengpan-pop").toggle()
        $(".so-shade").toggle()
    })
    $(".so-fengpan-pop").click(function () {
        $(".so-fengpan-pop").toggle()
        $(".so-shade").toggle()
    })
}
function initPop01() {
    $(".so-pop-01").click(function () {
        $(".so-pop-xxx").toggle()
        $(".so-shade").toggle()
    })
    $(".so-pop-xxx a").click(function () {
        $(".so-pop-xxx").toggle()
        $(".so-shade").hide()
    })
}