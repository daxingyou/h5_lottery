      ...
      <div id="index_content" class="content">
          ...
          <section class="cooper_area">
              <div class="cooper">
                  ...
                  <ul>
                      <li><div class="icon"><a class="icon_intro" href="h5_doublesided/lobbyTemplate/tutorial.html"></a></div></li>
                      <li><div class="icon"><router-link class="icon_agent" v-bind:to="'/lobbyTemplate/agent'"></router-link></div></li>
                      <li><div class="icon"><a class="icon_about" href="/h5_doublesided/lobbyTemplate/about.html"></a></div></li>
                  </ul>
              </div>
          </section>
      </div>
