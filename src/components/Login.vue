                ...
                <form>
                    <fieldset>
                        <div class="form_g account">
                            <legend></legend>
                            <input type="text" placeholder="请输入帐号" v-model="username" autocomplete="off" class="user-name" @input="checkUserName(username,'user-name','请输入4~15位英数帐号')" >
                    ...
                    <fieldset>
                        <div class="form_g password">
                            <legend></legend>
                            <input type="password" placeholder="请输入密码" v-model="password" autocomplete="off" class="pass-word"  @input="checkpassword(password,'pass-word','请输入6~20位英数密码')">
