                ...
                <div id="so-item2" class="jc115 tab_container tabBox" style="display:none;">
                    <div class="hd">
                        <ul class="tab tab_mid tab_two">
                            ...
                            <li><a href="javascript:;">前二组选</a></li>
                            <li><a href="javascript:;">前三组选</a></li>
                        </ul>
                    </div>
                    <div class="bd">
                        ...
                        <ul id="tab_jx_eze" class="tab_content ">
                            <li class="select-li">
                                <div>
                                    <h2>
                                        二中二
                        ...
                        <ul id="tab_jx_szs" class="tab_content ">
                            <li class="select-li">
                                <div>
                                    <h2>
                                            三中三
                        ...
                        <ul id="tab_jx_sizsi" class="tab_content ">
                            <li class="select-li">
                                <div>
                                    <h2>
                                        四中四
                        ...
                        <ul id="tab_jx_wzw" class="tab_content ">
                            <li class="select-li">
                                <div>
                                    <h2>
                                        五中五
                        ...
                        <ul id="tab_jx_lzw" class="tab_content ">
                            <li class="select-li">
                                <div>
                                    <h2>
                                        六中五
                        ...
                        <ul id="tab_jx_qzw" class="tab_content ">
                            <li class="select-li">
                                <div>
                                    <h2>
                                        七中五
                        ...
                        <ul id="tab_jx_bzw" class="tab_content ">
                            <li class="select-li">
                                <div>
                                    <h2>
                                        八中五
                        ...
                        <ul id="tab_jx_qez" class="tab_content ">
                            <li class="select-li">
                                <div>
                                    <h2>
                                        前二组选
                        ...
                        <ul id="tab_jx_qsz" class="tab_content ">
                            <li class="select-li">
                                <div>
                                    <h2>
                                        前三组选
